export const labs = [
  {
    ...
    description: 'Make an alert show in the browser',
  },
  {
    title: '.innerHTML reflection',
    description: 'Make an alert show in the browser',
  },
  {
    title: 'JavaScript Template Literals',
    description: `
Even <code>.innerText</code> is vulnerable when done wrong. Make an alert show in the browser. 
<br />      
The <code>&lt;</code>, <code>&gt;</code>, <code>&apos;</code> and <code>&quot;</code> characters are HTML encoded, and the <code>\`</code> character is escaped`,
    hints: [
      {
        summary: 'XSS vulnerability location',
        details: 'The reflected string is in a JS template literal',
      },
    ],
  },
  {
    ...
    hints: [
      {
        summary: 'XSS vulnerability location',
        details:
          'The website URL input does not check for <code>http://</code> or <code>https://</code> protocol',
      },
      {
